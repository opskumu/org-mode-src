...
- [[https://docs.docker.com/engine/reference/run/#runtime-constraints-on-resources][Runtime
  constraints on resources]]
- 关于 IO 的限制
  - ~--blkio-weight=0~
    - Block IO weight (relative weight) accepts a weight value between
      10 and 1000.
  - ~--blkio-weight-device=""~
...
测试下来，效果不是很理想，没有获得官方文档中的效果，类似的问题可以在相关的 issue 上找到，如 [[https://github.com/docker/docker/issues/16173][--blkio-weight doesn't take effect in docker Docker version 1.8.1 #16173]]
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/io-write-bps.png]]
...
- [[https://github.com/opencontainers/runc/tree/master/libcontainer/cgroups/fs][github.com/opencontainers/runc/libcontainer/cgroups/fs]]
  - blkio.go
...
- [[http://www.infoq.com/cn/articles/docker-kernel-knowledge-cgroups-resource-isolation][Docker背后的内核知识 - cgroups资源限制]]
- [[http://pan.baidu.com/share/home?uk=1429463486&view=share#category/type=0][cgroup 内存、IO、CPU、网络资源管理]]
