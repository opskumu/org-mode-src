...
- Docker: 开源的容器虚拟化平台
- Docker Hub: 用于分享、管理 Docker 容器的 Docker SaaS 平台 -- [[https://registry.hub.docker.com/search?q=library][Docker Hub]]

Docker 使用客户端-服务器 (C/S) 架构模式。Docker 客户端会与 Docker 守护进程进行通信。Docker 守护进程会处理复杂繁重的任务，例如建立、运行、发布你的 Docker 容器。Docker 客户端和守护进程可以运行在同一个系统上，当然你也可以使用 Docker 客户端去连接一个远程的 Docker 守护进程。Docker 客户端和守护进程之间通过 socket 或者 RESTful API 进行通信。

[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/docker_arch.png]]
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/libcontainer-linux.png]]

- 图片来源: [[http://blog.docker.com/2014/03/docker-0-9-introducing-execution-drivers-and-libcontainer/][Docker 0.9: introducing execution drivers and libcontainer]]
...
参考文档：[[https://blog.jtlebi.fr/2014/01/05/introduction-to-linux-namespaces-part-3-pid/][Introduction to Linux namespaces -- Part 3: PID]]
...
参考文档：[[https://blog.jtlebi.fr/2014/01/19/introduction-to-linux-namespaces-part-5-net/][Introductionto Linux namespaces -- Part 5: NET]]

**** uts namespace

UTS ("UNIX Time-sharing System") namespace 允许每个 container 拥有独立的 hostname 和 domain name, 使其在网络上可以被视作一个独立的节点而非 Host 上的一个进程。

参考文档：[[https://blog.jtlebi.fr/2013/12/22/introduction-to-linux-namespaces-part-1-uts/][Introductionto Linux namespaces -- Part 1: UTS]]
...
参考文档：[[https://blog.jtlebi.fr/2013/12/28/introduction-to-linux-namespaces-part-2-ipc/][Introduction to Linux namespaces -- Part 2: IPC]]
...
- [[http://tiewei.github.io/cloud/Docker-Getting-Start/][Docker Getting Start: Related Knowledge]]
...
参考文档：[[http://tiewei.github.io/devops/howto-use-cgroup/][how to use cgroup]]

** Docker 安装

docker 的相关安装方法这里不作介绍，具体安装参考 [[https://docs.docker.com/installation/][官方文档]]
...
[[https://registry.hub.docker.com/][Docker HUB]] ：Docker镜像首页，包括官方镜像和其它公开镜像

因为国情的原因，国内下载 Docker HUB 官方的相关镜像比较慢，可以使用 [[http://daocloud.com/][Daocloud]] 镜像加速。
...
#+BEGIN_QUOTE
By default all groups have 1024 shares. A group with 100 shares will get a ~10% portion of the CPU time - [[https://wiki.archlinux.org/index.php/cgroups][archlinux cgroups]]
#+END_QUOTE
...
- docker commit [OPTIONS] CONTAINER [REPOSITORY[:TAG]]
  - # 提交指定容器为镜像
  - -a, --author="" Author (e.g., "John Hannibal Smith [[mailto:hannibal@a-team.com][hannibal@a-team.com]]")
...
- docker logs CONTAINER
  ...
  - --tail="all" Output the specified number of lines at the end of logs
    (defaults to all logs)

参考文档：[[https://docs.docker.com/reference/run/][Docker Run Reference]]
...
参考文档：[[http://blog.docker.com/2014/10/docker-1-3-signed-images-process-injection-security-options-mac-shared-directories/][Docker 1.3: signed images, process injection, security options, Mac shared directories]]

*** Docker 1.5 新特性

参考文档：[[http://dockerone.com/article/202][Docker 1.5 新特性]]
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/docker_networking.png]]

图: [[http://www.slideshare.net/janghoonsim/docker-container-and-lightweight-virtualization][Docker - container and lightweight virtualization]]
...
四种网络模式摘自[[http://www.infoq.com/cn/articles/docker-network-and-pipework-open-source-explanation-practice][Docker网络详解及 pipework 源码解读与实践]]
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/vethbridge.png]]

图：[[http://www.wickedawesometech.us/2014/07/the-container-world-part-2-networking.html][The Container World Part 2 Networking]]
...
参考文档: [[https://docs.docker.com/articles/networking/][Network Configuration]]
...
桥接网络可以参考 [[https://github.com/opskumu/Day/blob/master/tips/tips.md][日常问题处理 Tips]] 关于桥接的配置说明，这里不再赘述。
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/docker_bridge.png]]
...
- [[https://github.com/jpetazzo/pipework][Pipework 官方文档]]
- [[http://www.infoq.com/cn/articles/docker-network-and-pipework-open-source-explanation-practice][Docker 网络详解及 pipework 源码解读与实践]]
...
<src> 支持通过 GO 的正则模糊匹配，具体规则可参见 [[http://golang.org/pkg/path/filepath/#Match][Go filepath.Match]]
...
参考文档：[[https://docs.docker.com/reference/builder/][Dockerfile Reference]]
...
在大多数情况下，一个容器应该只单独跑一个程序。解耦应用到多个容器使其更容易横向扩展和重用。如果一个服务依赖另外一个服务，可以参考 [[https://docs.docker.com/userguide/dockerlinks/][Linking Containers Together]]。
...
- [[http://dockerone.com/article/131][Dockerfile最佳实践（一）]]
- [[http://dockerone.com/article/132][Dockerfile最佳实践（二）]]
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/docker_data.png]]
...
- [[http://docs.docker.com/userguide/dockervolumes/#data-volumes][Managing Data in Containers]]
- [[http://dockerone.com/article/128][深入理解Docker Volume（一）]]
- [[http://dockerone.com/article/129][深入理解Docker Volume（二）]]
...
Docker 官方提供了 docker registry 的构建方法 [[https://github.com/docker/docker-registry][docker-registry]]
...
这种方法通过 Docker hub 使用官方镜像 [[https://registry.hub.docker.com/_/registry/][official image from the Docker hub]]
...
- [[https://github.com/docker/docker-registry/blob/master/README.md][Docker-Registry README]]
- [[https://github.com/docker/docker-registry/blob/master/ADVANCED.md][Docker-Registry advanced use]]
