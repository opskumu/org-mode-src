...
#+TITLE: Docker CPU 资源限制
#+DATE: <2016-03-27 Sun>

** 压测工具

同上文 [[file:docker-memory-limit.org][Docker 内存资源限制]] 使用 stress 测试。
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/cpu-test.png]]
...
- [[https://www.kernel.org/doc/Documentation/scheduler/sched-bwc.txt][CFS documentation on bandwidth limiting]]
...
=--cpuset-mems= 只应用于 NUMA 架构的 CPU 生效，这个选项这里不过多介绍。关于 NUMA 架构可以参考这篇文章 [[http://cenalulu.github.io/linux/numa/][NUMA架构的CPU -- 你真的用好了么？]]。
