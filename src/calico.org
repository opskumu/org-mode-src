...
- [[http://docs.projectcalico.org/v2.0/reference/][Calico Reference]]
- [[http://docs.projectcalico.org/v2.0/usage/][Calico Usage]]
...
- *bgpPeer*
  - [[http://docs.projectcalico.org/v2.0/reference/private-cloud/l3-interconnect-fabric][Calico's documentation on L3 Topologies]]
...
#+BEGIN_QUOTE
此处 node 官方文档标明为主机名，另外实际测试中如果此处指定 calico node 启动时指定的节点名「非主机名」时，跨容器路由会有问题，所以此处必须标注为主机名。
#+END_QUOTE
...
关于规则的设置，当前还没有实际使用，具体可参考官网内容 [[http://docs.projectcalico.org/v2.0/reference/calicoctl/resources/policy][Policy Resource (policy)]] 和 [[http://docs.projectcalico.org/v2.0/reference/calicoctl/resources/profile][Profile Resource(profile)]]。

- [[http://docs.projectcalico.org/v2.0/reference/calicoctl/resources/workloadendpoint][Workload Endpoint Resource (workloadEndpoint)]]

** [[http://docs.projectcalico.org/v2.0/reference/cni-plugin/configuration][Calico CNI Plugins]]

** [[http://docs.projectcalico.org/v2.0/usage/configuration/bgp][BGP Peering]]
