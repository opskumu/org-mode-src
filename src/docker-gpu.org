...
在讲解 Docker 中使用 GPU 之前，需要先在当前宿主上安装好 CUDA，本文介绍的是基于 CentOS7 的安装，关于更多 Linux 的安装方法，可以参考官方文档 [[http://docs.nvidia.com/cuda/cuda-installation-guide-linux][NVIDIA CUDA Installation Guide for Linux]]。
...
[[https://developer.nvidia.com/cuda-downloads][CUDA Toolkit Download]] 官网下载，选择所对应的版本

[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/cuda-download.png]]
...
nvidia 官方提供了 nvidia-docker 可以直接驱动 GPU 设备，具体文档可以参考 [[https://github.com/NVIDIA/nvidia-docker][nvidia-docker]]，本文介绍原生的 Docker 方式。

[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/docker-gpu.png]] > Example of how CUDA integrates with Docker
...
K8s 现在已经支持 GPU 的资源调度了，具体可以看官方的介绍 [[https://kubernetes.io/docs/tasks/manage-gpus/scheduling-gpus/][Schedule GPUs]]，这里介绍一个简单的实例。
