...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/mysql_rep/mysql_rep1.jpg]]
...
1. 监控和管理复制的账号需要 REPLICATION CLIENT
   权限，使用同一账号方便管理
2. 方便角色切换
...
[[https://opskumu.oss-cn-beijing.aliyuncs.com/images/mysql_rep/mysql_rep2.jpg]]
...
- A->B->C 方式 
    - B 为从和主身份时，B 实例上需要设置 =logs-slave-updates= 选项，这个选项告诉从服务器将其 SQL 线程执行的更新记录到从服务器自己的二进制日志上，当然前提是需要开启 binlog
...
- [[http://dev.mysql.com/doc/refman/5.6/en/index.html][MySQL 5.6 Reference Manual]]
