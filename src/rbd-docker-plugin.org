...
- rbd plugin: [[https://github.com/yp-engineering/rbd-docker-plugin][rbd-docker-plugin]]
...
#+BEGIN_QUOTE
关于 ceph/demo 镜像的更多说明可以参考 [[https://github.com/ceph/ceph-docker/tree/master/demo][ceph/ceph-docker/demo]]
#+END_QUOTE

** 运行 rbd docker plugin
...
- [[http://www.sebastien-han.fr/blog/2015/08/17/getting-started-with-the-docker-rbd-volume-plugin/][Getting Started With the Docker RBD Volume Plugin]]
- [[https://github.com/yp-engineering/rbd-docker-plugin][Ceph Rados Block Device Docker VolumeDriver Plugin]]
