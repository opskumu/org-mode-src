...
关于filter的匹配规则可以参考[[http://www.samba.org/ftp/rsync/rsyncd.conf.html][man手册]]：
...
- [[http://www.samba.org/ftp/rsync/rsyncd.conf.html][rsync man 手册]]
- [[http://www.howtocn.org/rsync:use_rsync][howtocn rsync 文档]]
- [[http://blog.clanzx.net/2013/08/23/rsync-backup.html][使用 rsync 进行文件备份]]
